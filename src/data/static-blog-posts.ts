...
export const STATIC_BLOG_POSTS: Record<string, StaticBlogMeta> = {
  "/resources/blogs/hrblogs": {
    ...
    title: "Remote Work HR Strategies 2025 | OfficeKit HR Blog",
    description:
      "Discover practical HR strategies for remote and hybrid teams in 2025 — engagement, compliance, payroll, and performance with modern HRMS tools.",
    headline: "The Future of Remote Work: HR Strategies for 2025 and Beyond",
    author: "Aiswarya K",
