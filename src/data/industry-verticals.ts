...
export const INDUSTRY_PAGES: Record<string, IndustryConfig> = {
  ...
  "hrms-for-manufacturing": {
    ...
    metaDescription: "Manufacturing HRMS with shift attendance, Face-Kit biometric, blue-collar payroll, and India+GCC statutory compliance.",
    h1: "HRMS for manufacturing",
    subtitle: "Shift-based attendance, factory payroll, and compliance for manufacturing plants in India and the GCC.",
    directAnswer: "OfficeKit HR is an HRMS for manufacturing with shift scheduling, biometric and Face-Kit attendance, overtime rules, and statutory payroll for factory workforces in India and GCC countries.",
    challenges: ["Shift and overtime tracking", "Blue-collar attendance at scale", "Multi-location plants", "Statutory compliance across states/countries"],
    facts: [{ heading: "Manufacturing HR", body: "Factory floors need reliable attendance, shift rules, and payroll linked to production schedules." }],
    capabilities: ["Shift scheduling", "Face-Kit attendance", "Overtime policies", "India PF/ESI", "GCC WPS payroll"],
    faqs: [{ question: "Does OfficeKit support factory shift attendance?", answer: "Yes. Biometric, mobile, and Face-Kit attendance with shift rules and overtime calculation." }],
    relatedLinks: [{ label: "Face-Kit", href: "/features/face-kit" }, { label: "Construction HRMS", href: "/best-hrms-for-construction" }],
  },
  "hrms-for-it-services": {
    ...
    metaDescription: "HRMS for IT services and software companies: recruitment, performance, India payroll, and GCC expansion support.",
    h1: "HRMS for IT services",
    subtitle: "Recruitment, performance, and payroll for IT companies scaling in India and the Gulf.",
    directAnswer: "OfficeKit HR is an HRMS for IT companies with ATS, OKRs, India statutory payroll, and GCC modules for firms expanding to Dubai, Riyadh, or other Gulf hubs.",
    challenges: ["Rapid hiring", "Performance and OKRs", "India+GCC entity setup", "Remote/hybrid attendance"],
    facts: [{ heading: "IT sector HR", body: "IT firms need fast recruitment pipelines and payroll that scales when opening GCC subsidiaries." }],
    capabilities: ["ATS recruitment", "OKRs & performance", "India payroll", "GCC payroll add-on", "Employee self-service"],
    faqs: [{ question: "Is OfficeKit good for IT companies with UAE offices?", answer: "Yes. One HRMS for India HQ and UAE/GCC subsidiaries with WPS payroll and India statutory compliance." }],
    relatedLinks: [{ label: "Bangalore HRMS", href: "/solutions/hrms-software-bangalore" }, { label: "Recruitment", href: "/features/recruitment-management" }],
  },
  "hrms-for-healthcare": {
    ...
    metaDescription: "Healthcare HRMS for hospitals and clinics: shift rostering, credential tracking, and India+GCC payroll.",
    h1: "HRMS for healthcare",
    subtitle: "Shift rostering, compliance, and payroll for hospitals, clinics, and healthcare groups.",
    directAnswer: "OfficeKit HR supports healthcare workforce management with shift scheduling, document expiry alerts, attendance, and statutory payroll for clinical and admin staff in India and the GCC.",
    challenges: ["24/7 shift rostering", "Credential and licence expiry", "Multi-location clinics", "Regulatory record-keeping"],
    facts: [{ heading: "Healthcare workforce", body: "Hospitals need reliable shift management and audit-ready payroll for clinical staff." }],
    capabilities: ["Shift rostering", "Document expiry alerts", "Attendance tracking", "Statutory payroll", "Employee self-service"],
    faqs: [{ question: "Can OfficeKit manage nurse shift schedules?", answer: "Yes. Configurable shift rules, rotations, and overtime for 24/7 healthcare operations." }],
    relatedLinks: [{ label: "Healthcare HR page", href: "/hr-software-healthcare" }, { label: "Attendance", href: "/features/attendance-and-leave" }],
  },
  "hrms-for-real-estate": {
    ...
    metaDescription: "HRMS for real estate and property companies: commission payroll, WPS compliance, and multi-branch workforce management.",
    h1: "HRMS for real estate",
    subtitle: "Commission payroll, WPS compliance, and HR for property developers and brokerages.",
    directAnswer: "OfficeKit HR is an HRMS for real estate companies with variable pay for agents, UAE WPS payroll, gratuity, and India statutory payroll for property firms operating across India and the Gulf.",
    challenges: ["Agent commission structures", "Multi-branch sales teams", "UAE WPS for property firms", "High turnover in sales roles"],
    facts: [{ heading: "Real estate payroll", body: "Property firms need flexible commission pay components alongside base salary and WPS compliance in UAE." }],
    capabilities: ["Commission pay components", "WPS payroll UAE", "Gratuity calculation", "Mobile attendance", "India payroll"],
    faqs: [{ question: "Does OfficeKit handle real estate agent commissions?", answer: "Yes. Variable pay components for commissions and bonuses integrate into regular payroll runs." }],
    relatedLinks: [{ label: "Payroll UAE", href: "/payroll-software-uae" }, { label: "Dubai HR", href: "/hr-software-dubai" }],
  },
};
