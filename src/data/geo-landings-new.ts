...
export const GEO_LANDINGS_NEW: Record<string, GeoLandingConfig> = {
  ...
  "hrms-software-pune": {
    slug: "hrms-software-pune",
    path: "/solutions/hrms-software-pune",
    title: "HRMS Software Pune | Maharashtra Payroll — OfficeKit HR",
    metaDescription:
      "HRMS for Pune and Maharashtra: statutory payroll, attendance, recruitment, and GCC expansion for IT and manufacturing companies.",
    h1: "HRMS software for Pune",
    subtitle: "Statutory payroll and HR automation for Pune-based teams scaling across India and the GCC.",
    directAnswer:
      "OfficeKit HR is HRMS software for Pune companies that need Maharashtra Professional Tax, PF/ESI payroll, attendance, and recruitment — with GCC payroll when you expand to UAE or Saudi Arabia.",
    definition: { term: "Pune HRMS", meaning: "HR software for Pune and Maharashtra employers covering statutory India payroll and optional GCC modules." },
    facts: [{ heading: "Pune HR market", body: "Pune's IT, manufacturing, and automotive sectors need multi-state payroll and scalable HRMS as teams grow beyond 50 employees." }],
    capabilities: ["Maharashtra PT payroll", "PF, ESI, TDS", "Biometric attendance", "Recruitment ATS", "GCC payroll add-on"],
    faqs: [{ question: "What is the best HRMS for Pune IT companies?", answer: "OfficeKit HR offers per-user pricing, India statutory payroll, and GCC modules for Pune IT firms expanding internationally." }],
    relatedLinks: [{ label: "HRMS India", href: "/hrms-software-india" }, { label: "Pricing", href: "/pricing" }],
  },
  "hrms-software-ahmedabad": {
    slug: "hrms-software-ahmedabad",
    path: "/solutions/hrms-software-ahmedabad",
    title: "HRMS Software Ahmedabad | Gujarat Payroll — OfficeKit HR",
    metaDescription: "HRMS for Ahmedabad and Gujarat: statutory payroll, attendance, and employee self-service for SMEs and enterprises.",
    h1: "HRMS software for Ahmedabad",
    subtitle: "Gujarat-ready payroll and HR for Ahmedabad's trading, textile, and pharma companies.",
    directAnswer: "OfficeKit HR provides HRMS for Ahmedabad with Gujarat Professional Tax, PF/ESI payroll, attendance, and modular GCC payroll for exporters with Gulf operations.",
    facts: [{ heading: "Ahmedabad payroll", body: "Gujarat employers need PT, PF, ESI compliance plus attendance for factory and office workforces." }],
    capabilities: ["Gujarat PT", "PF/ESI/TDS", "Shift attendance", "Employee self-service", "Multi-entity payroll"],
    faqs: [{ question: "Does OfficeKit support Gujarat Professional Tax?", answer: "Yes. OfficeKit calculates Gujarat PT alongside PF, ESI, and TDS for Ahmedabad-based employers." }],
    relatedLinks: [{ label: "Payroll India", href: "/payroll-software-india" }, { label: "Book demo", href: "/contact" }],
  },
  "payroll-software-abu-dhabi": {
    slug: "payroll-software-abu-dhabi",
    path: "/solutions/payroll-software-abu-dhabi",
    title: "Payroll Software Abu Dhabi | WPS-Ready — OfficeKit HR",
    metaDescription: "Payroll software for Abu Dhabi with WPS compliance, gratuity, and HRMS integration for mainland and free-zone companies.",
    h1: "Payroll software for Abu Dhabi",
    subtitle: "WPS-ready payroll and HR for Abu Dhabi mainland and free-zone employers.",
    directAnswer: "OfficeKit HR is payroll software for Abu Dhabi that generates WPS-compliant salary files, calculates gratuity, and integrates attendance with pay runs for UAE entities.",
    facts: [{ heading: "Abu Dhabi WPS", body: "Abu Dhabi employers must pay salaries via approved WPS channels with valid SIF files and employee IBANs." }],
    capabilities: ["WPS SIF export", "Gratuity accrual", "Multi-entity UAE", "Arabic ESS", "India payroll add-on"],
    faqs: [{ question: "Is OfficeKit WPS-compliant for Abu Dhabi?", answer: "Yes. OfficeKit generates WPS-compliant SIF files and validates IBANs before bank submission." }],
    relatedLinks: [{ label: "WPS guide", href: "/knowledge/wps-compliance" }, { label: "Payroll UAE", href: "/payroll-software-uae" }],
  },
  "payroll-software-jeddah": {
    slug: "payroll-software-jeddah",
    path: "/solutions/payroll-software-jeddah",
    title: "Payroll Software Jeddah | GOSI & KSA Compliance — OfficeKit HR",
    metaDescription: "Payroll software for Jeddah and Western Province employers with GOSI calculations and Saudi labour law compliance.",
    h1: "Payroll software for Jeddah",
    subtitle: "GOSI-aligned payroll for Jeddah employers with HRMS integration.",
    directAnswer: "OfficeKit HR is payroll software for Jeddah that calculates GOSI contributions, manages KSA payroll runs, and supports multi-country operations alongside India and UAE entities.",
    facts: [{ heading: "Jeddah payroll", body: "Western Province employers must remit GOSI contributions and maintain MHRSD-compliant payroll records." }],
    capabilities: ["GOSI calculations", "KSA payroll runs", "Arabic ESS", "Attendance integration", "Multi-GCC support"],
    faqs: [{ question: "Does OfficeKit support GOSI for Jeddah companies?", answer: "Yes. OfficeKit calculates employer and employee GOSI contributions for KSA payroll." }],
    relatedLinks: [{ label: "KSA payroll", href: "/solutions/payroll-software-ksa" }, { label: "Pricing", href: "/pricing" }],
  },
};
